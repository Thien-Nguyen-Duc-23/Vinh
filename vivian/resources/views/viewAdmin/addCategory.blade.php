...
<head>
    ...
    @include("viewAdmin.viewAdmin.elements.stylesheet")
...
<form action="https://demo.s-cart.org/system_admin/shop_order" method="get" class="search-form" pjax-container>
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form action="https://demo.s-cart.org/system_admin/shop_category" method="post" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" pjax-container>
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            <input type="text" id="en__name" name="en__name" value="" class="form-control en__name" placeholder="Input Tên" />
...
<label for="parent" class="col-sm-2  control-label">Parent category</label>
    ...
    <div class="col-sm-8">
        ...
        <select class="form-control parent" style="width: 100%;" name="parent" data-value="" >
                            <option value=""></option>
