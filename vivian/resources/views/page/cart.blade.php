                ...
                <tr>
                  ...
                  <td>
                    <div class="shopping-cart-table__input">
                      <input type="number" name="amount" id="updates_31530897420" class="form-control input-desktop" value="{{$product['qty']}}" min="1" max="100000" title="Many in stock">
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <a href="{{route('updateCart')}}">
                    <button type="submit" class="btn btn--ys btn--light pull-right" id="update-cart" style="margin-left: 15px" name="update">
