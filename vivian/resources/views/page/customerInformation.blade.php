                        ...
                        <div class="fieldset">
                          <div class="field field--required">
                            ...
                            <div class="field__input-wrapper">
                              <input placeholder="Email" autocapitalize="off" spellcheck="false" autocomplete="shipping email" data-trekkie-id="email_field" data-autofocus="true" data-backup="customer_email" aria-describedby="checkout-context-step-one" aria-required="true" class="field__input" size="30" type="email" value="aa@gmail.com" name="email" id="checkout_email" />
                            </div>
                          </div>
                        </div>
                      </div> 
                      ...
                      <div class="section__content">
                        <div class="fieldset" data-address-fields>
                          ...
                          <div class="field--half field field--optional" data-address-field="first_name">
                            ...
                            <div class="field__input-wrapper">
                              <input placeholder="Gender" autocomplete="shipping given-name" data-trekkie-id="shipping_firstname_field" data-backup="first_name" class="field__input" size="30" type="text" value="ads" name="gender" id="checkout_shipping_address_first_name" />
                            </div>
                          </div>
                        ...
                        <div class="section__content">
                          <fieldset class="content-box">
                            ...
                            <div class="radio-wrapper content-box__row" data-different-billing-address>
                              ...
                              <a target="_blank" href="https://www.nganluong.vn/button_payment.php?receiver=(Ducvinhnguyen2609@gmail.com)&product_name=(Mã đơn đặt hàng)&price=(@if(Session::has('cart')){{number_format($totalPrice + 20000)}} @else 0 @endif)&return_url=(URL thanh toán thành công)&comments=(Ghi chú về đơn hàng)"><img src="https://www.nganluong.vn/css/newhome/img/button/safe-pay-2.png"border="0" /></a>
                          </fieldset>
                        </div> 
                      </div>
